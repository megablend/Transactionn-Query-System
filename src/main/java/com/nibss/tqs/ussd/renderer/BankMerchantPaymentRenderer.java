...
public class BankMerchantPaymentRenderer implements MerchantPaymentRenderer {
    ...
    public ByteArrayOutputStream download(DownloadType downloadType, List<AjaxMcashTransaction> transactions) {
        try {
            ...
            throw new RuntimeException("could nt gen mer.pay. rpt", e);
        }
    }
    ...
    public List<String> getTableHeader() {
        return Arrays.asList("MERCHANT", "MERCHANT CODE",
                "TELCO", "USSD AGGR.",
                "SESSION ID","REFERENCE CODE", "PAYMENT REF.",
                "PHONE NO.",
                "AMT. (N)",
                "FEE (N)",
