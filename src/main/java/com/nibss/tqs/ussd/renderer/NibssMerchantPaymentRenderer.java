...
public class NibssMerchantPaymentRenderer implements MerchantPaymentRenderer {
    ...
    public List<String> getTableHeader() {
        return Arrays.asList("MERCHANT","MERCHANT CODE",
                "TELCO", "USSD AGGR.",
                "SOURCE BANK","DEST. BANK", "SESSION ID",
                "REFERENCE CODE",
                "PAYMENT REF.",
                "PHONE NO.",
                "AMOUNT (N)", "FEE (N)",
                "TRANSACTION DATE", "DEBIT STATUS", "CREDIT STATUS");
    }
