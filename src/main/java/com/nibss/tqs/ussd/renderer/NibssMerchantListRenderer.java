...
public class NibssMerchantListRenderer implements MerchantListRenderer {
    ...
    public List<String> getTableHeader() {
        return Arrays.asList("Merchant Code",
                "Name",
        "Email", "Phone Number","Account Number", "Account Name", "Bank", "LGA", "State", "Status", "Date Created");
    }
    ...
    private List<Object[]> buildJson(List<Merchant> merchants) {
        ...
        merchants.forEach( m -> {
            ...
            if(m.getMerchantAccountList() != null && !m.getMerchantAccountList().isEmpty()) {
                ...
                temp.add(merchantAccount.getInstitution().getInstitutionName());
            } else {
                temp.add("");
                temp.add("");
                temp.add("");
