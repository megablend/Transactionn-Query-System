...
public class BankTransactionRenderer implements EbillsTransactionRenderer {
    ...
    public ByteArrayOutputStream download(DownloadType downloadType, List<AjaxEbillsPayTransaction> transactions) throws IOException {
        try {
           ...
           throw new RuntimeException("could not generate ebillspay report",e);
        }
    }
